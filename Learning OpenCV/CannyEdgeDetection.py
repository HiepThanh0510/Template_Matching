...
def my_canny(img, min_val, max_val, sobel_size=3, is_L2_gradient=False):
    ...
    #2. Tính Gradient và hướng gradient
    ...
    #4. Hysteresis Thresholding (Lọc ngưỡng)   
...
img = cv2.imread('/home/thanh/Pictures/image.jpeg', 0)
my_canny = my_canny(img, min_val=100, max_val=200)
edges = cv2.Canny(img, 100, 200)

cv2.imshow('Canny code chay', my_canny)
